...
DR['APE.WM'] = DRule(  11.0,  60.0, 'PMOS','AP-GC','Wmin/max' )
DR['APE.LM'] = DRule(   2.0,  30.0, 'PMOS','GC-AN','Lmin/max' )
DR['APE.AN'] = DRule(  10.0,  -1.0, 'APE','AN','Smin' )
DR['APE.XY'] = DRule(   1.4,  -1.0, 'APE','Bevel','XYmin' )
DR['APE.CO'] = DRule(   2.0,  -1.0, 'APE','CO','Smin' )
DR['ANE.WM'] = DRule(  11.0,  60.0, 'NMOS','AN-GC','Wmin/max' )
DR['ANE.LM'] = DRule(   2.0,  30.0, 'NMOS','GC-AN','Lmin/max' )
...
DR['COE.S1'] = DRule(   1.6,  -1.0, 'CO(E) ','','Smin' )
...
DR['M2.PE'] = DRule(  19.0,  -1.0, 'M2','Extention','' )
DR['M2.PW'] = DRule(  40.0,  -1.0, 'M2','Extention','Wmin' )
DR['M1.PE'] = DRule(  19.0,  -1.0, 'M2','Extention','' )
DR['M1.PW'] = DRule(  40.0,  -1.0, 'M2','Extention','Wmin' )
